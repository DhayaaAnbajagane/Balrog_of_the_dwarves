...
output="$PREP_DIR/amandine_test/outputs_test"
bands="gr"
tilename="DES1003-2706"

NOW=$( date "+%H:%M:%S" )
echo "Starting galsim stage at $NOW"

echo $CAT_PATH
export CAT_PATH=/home/dhayaa/Desktop/DECADE/Balrog_of_the_deep/TestInjection.fits
export CAT_PATH=/home/dhayaa/Desktop/DECADE/Balrog_of_the_deep/TestInjection_V2.fits
echo $CAT_PATH

export DESDM_CONFIG=/home/dhayaa/Desktop/DECADE/Balrog_of_the_deep/Y6DESDM/
...
then
    ...
    # NOW=$( date "+%H:%M:%S" )
    # echo "Completed source-extractor and starting subselect at $NOW"
...
# #     NOW=$( date "+%H:%M:%S" )
# #     echo "Completed subselect and starting meds at $NOW"
